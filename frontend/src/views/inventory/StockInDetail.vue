...
<template>
    <el-card>
        <div class="header-actions" style="margin-bottom:20px">
            <el-button type="primary" @click="router.push('/dashboard/inventory/stock-in-create')">新增入库单</el-button>
            <el-button @click="router.push('/dashboard/inventory/stock-in-list')">历史单据</el-button>
        </div>
        <div v-if="record">
            <el-descriptions title="入库单详情" :column="3" border>
                ...
                <el-descriptions-item label="入库单号">{{ record.recordNo }}</el-descriptions-item>
                ...
                <el-descriptions-item label="入库数量">{{ record.quantity }}</el-descriptions-item>
                <el-descriptions-item label="成本单价">¥{{ record.unitPrice || 0 }}</el-descriptions-item>
                <el-descriptions-item label="成本金额">¥{{ record.totalAmount || 0 }}</el-descriptions-item>
